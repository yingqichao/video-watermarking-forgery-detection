...
class BaseModel():
    ...
    # def save_network_new(self, network, dataset_name, timestamp, network_label, iter_label, save_dir=None):
    #     # save_dir = '../experiments/pretrained_models/'
    #     if save_dir is None:
    #         save_filename = '{}_{}.pth'.format(iter_label, network_label)
    #         save_dir = os.path.join(self.opt['path']['models'], dataset_name, timestamp) + '/models'
